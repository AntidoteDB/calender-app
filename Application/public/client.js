...
function onChangeCbCalendars(e){                // event, if another calendar was selected
    ...
    if(currentCalendar == "Global"){
        ...
        disableInput();                         // if 'global' calendar is selected, inputform should be readonly
    }
    else {
        document.getElementById("calInfoGlobal").style.display = "none";
        enableInput();  //.. otherwise it should be editable
    }
