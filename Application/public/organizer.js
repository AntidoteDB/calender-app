...
function addNewParticipant() { // send addParticipant request
    ...
    {
        serverRequest("/api/addParticipant",{name:val}, function (json) { // "val" covers the new participant name
...
function removeParticipant(){ // send removeParticipant request
    ...
    serverRequest("/api/removeParticipant", {participant: currentParticipant}, function (json) {
...
function editAppointment(){ // send editAppointment request. This is NOT invoked after solving conflicts
    ...
    serverRequest("/api/editAppointment", {id:currentID, app:newApp,calendar:currentCalendar, comment:getCurrentDate() + ": edited by " + currentParticipant}, function (json) {
...
function addAppointment() {     // send addAppointment request
    ...
    serverRequest("/api/addAppointment", {calendar:currentCalendar,appointment:app}, function (json) {
...
function addComment() {     // send addComment request
    ...
    serverRequest("/api/addComment", {id:currentID,comment: getCurrentDate() + ", "+currentParticipant + ": " + val}, function (json) {
...
function solveAppointment() { // after the "right" value versions were selected, a editAppointment request is performed
    ...
    serverRequest("/api/editAppointment", {id:currentID, app:app,calendar:currentCalendar, comment:getCurrentDate() + ": conflict solved by " + currentParticipant}, function (json) {
        consoleAdd("editAppointment: " + json.result);
